...
## Input format:
This script is expeting the CSV file have the datetime columns with the following format: `dd/mmm/yy h:mm am/pm`
...
## Usage
```bash
python jira_export_cleaner.py -i <input_file> -c <column_names> -o <output_file> -l <log_file>
```
